...
def main():
	...
	APPLE_PRICE = input("Price 1 kg of apple: ") # k VND
	apple_weight = input("Enter weight of apples: ")# trọng lượng táo
	money_given = input("Total money customer give you: ")# tiền khách đưa

	apple_weight = float(apple_weight)
	money_given = float(money_given)
	APPLE_PRICE = float(APPLE_PRICE)

	total_price = calc_total_price(apple_weight, APPLE_PRICE)#tổng giá 
	money_return = calc_return(total_price, money_given)#tiền trả lại
